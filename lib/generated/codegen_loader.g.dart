...
class CodegenLoader extends AssetLoader{
  ...
  "form": {
    ...
    "city": "Город",
    "street": "Улица",
    "address_apartment": "Улица / Дом / Кв",
  ...
  "notification": {
    ...
    "cancel_delivery_reason_1": "Неверный номер телефона",
    "cancel_delivery_reason_2": "Неверный адрес",
    "cancel_delivery_reason_3": "Переадресация",
    "cancel_delivery_reason_4": "Не смог связаться с клиентом",
    "you_have_not_reviewed_yet": "Вы ещё не оставили отзыв",
    "delete_review_description": "Вы действительно хотите удалить отзыв?",
  ...
  "general": {
    ...
    "price": "Цена:",
    "scan_barcode": "Наведите камеру на штрих код"
  },
  "navigation": {
    ...
    "rate_and_review": "Оценить и оставить отзыв",
    "rate": "Оценить"
  },
  "status": {
