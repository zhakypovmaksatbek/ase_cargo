...
class _SenderFormViewState extends State<SenderFormView> with SenderFormMixin {
  ...
  void initState() {
    super.initState();
    context.read<ShipmentCubit>().getShipmentOptions();
                ...
                if (step < 3) {
                  ...
                  showDialog(
                      ...
                      builder: (context) => AlertDialog(
                            ...
                            content: AppText(
                                title: LocaleKeys.notification_please_wait.tr(),
                                textType: TextType.body),
                          ));
              ...
              child: Scaffold(
                  appBar: AppBar(
                    ...
                    leading: BackButton(
                      ...
                      onPressed: () async {
                        final bool? isConfirm = await AppDialogs.warningDialog(
                          context,
                          message:
                              LocaleKeys.notification_want_to_exit_page.tr(),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              DefTextField(
                                  ...
                                  onChanged: (p0) {
                                    addition.value =
                                        addition.value.copyWith(comment: p0);
                                  },
                                  maxLines: 3,
                          ...
                          content: ValueListenableBuilder(
                              ...
                              builder: (context, options, _) {
                                return FourthStepContent(
                                  ...
                                  onPayerChanged: (value) {
                                    addition.value = addition.value.copyWith(
                                      personalPayment: value == Payer.sender,
                                    );
                                  },
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          AppText(
              title: packagesDetail.description ?? "", textType: TextType.body),
